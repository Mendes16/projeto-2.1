...
<form method="POST" action="conexao.php" onsubmit="return valida_dados(this)">
    ...
    <input class="tipoFisico" type="text" name="fisico" placeholder="Digite seu CPF">
    <p>tipo de acessibilidade</p>
    <select class="tipoFisico" name="fisico" size="1">
    ...
    <input class="tipoJuridico" type="text" name="juridico" placeholder="Nome da empresa">
    <input class="tipoJuridico" type="text" name="juridico" placeholder="Digite o CNPJ">
